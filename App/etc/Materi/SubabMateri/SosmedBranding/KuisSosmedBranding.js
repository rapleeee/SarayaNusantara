...
const shuffleArray = (array) => {
  let shuffledArray = array.slice(); // Salin array agar tidak merubah array asli
...
const KuisSosmedBranding = ({ navigation }) => {
  ...
  // Mengacak pertanyaan saat komponen pertama kali dirender
  const [questions, setQuestions] = useState(shuffleQuestions(reactQuestionsSosmed));
